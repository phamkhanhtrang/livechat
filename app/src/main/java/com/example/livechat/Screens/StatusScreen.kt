...
import com.example.livechat.CommonDivier
...
fun StatusScreen(vm: LCViewModel, navController : NavController) {
    val inProcess = vm.inProcessStatus.value
    if(inProcess){
        CommonProgressBar()
    }else{
        ...
        Scaffold (
            ...
            content = {
                Column(modifier = Modifier
                    ...
                    BottomNavigationMenu(selectedItem = BottomNavigationItem.STATUSLIST,
                        navController = navController)
                }
            }
        )
